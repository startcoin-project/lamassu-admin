(function( $ ) {
  ...
  $.fn.customSelectMenu = function( options ) {
    ...
    var settings = $.extend( {
      ...
      activeClass : 'is-open', /* The class given to the label when the menu is visible */
    ...
    function updateMenu( selection ) {
      ...
      selection.parent().parent().removeClass( settings.activeClass );
      // Close the menu
    ...
    return this.each(function() {
      ...
      newContainer.on( 'click', function( event ){
        ...
        if( target.is( 'label' ) ){
          newLabel.parent().toggleClass( settings.activeClass );
      ...
      $('html').on( 'mousedown', function( event ) {
        ...
        if ( !target.parents().addBack().is( '.' + settings.menuClass + ' ul, .' + settings.menuClass + ' label' ) ) {
          // Clicked outside
          $('.' + settings.menuClass).removeClass( settings.activeClass );
